...
class ActorAdapter : ListAdapter<FilmCrewUiModel, ActorViewHolder>(ActorDiffUtil()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ActorViewHolder =
        ActorViewHolder(ItemFilmCrewBinding.bind(parent.inflate(R.layout.item_film_crew)))

    override fun onBindViewHolder(holder: ActorViewHolder, position: Int) =
        holder.bind(getItem(position))
}

class ActorViewHolder(private val binding: ItemFilmCrewBinding) : RecyclerView.ViewHolder(binding.root) {
...
class ActorDiffUtil : DiffUtil.ItemCallback<FilmCrewUiModel>() {
