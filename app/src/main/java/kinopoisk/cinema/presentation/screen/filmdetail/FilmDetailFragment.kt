...
class FilmDetailFragment : Fragment(), HasAndroidInjector {
    ...
    private fun handleUiState(filmDetailUiState: FilmDetailUiState) {
        when (filmDetailUiState) {
            ...
            is FilmDetailUiState.Content -> updateUiState(filmDetailUiState)
        }
    }

    private fun updateUiState(filmDetailUiState: FilmDetailUiState.Content) {
        with(binding) {
            ...
            tvTitleActor.isVisible = filmDetailUiState.filmDetailUiModel.isActorsVisible
            tvCountActor.isVisible = filmDetailUiState.filmDetailUiModel.isActorsVisible
            tvTitleStaff.isVisible = filmDetailUiState.filmDetailUiModel.isStaffVisible
            tvCountStaff.isVisible = filmDetailUiState.filmDetailUiModel.isStaffVisible
            tvTitleGallery.isVisible = filmDetailUiState.filmDetailUiModel.isGalleryVisible
            tvCountGallery.isVisible = filmDetailUiState.filmDetailUiModel.isGalleryVisible
            tvTitleSimilarFilm.isVisible = filmDetailUiState.filmDetailUiModel.isSimilarVisible
            tvCountSimilarFilm.isVisible = filmDetailUiState.filmDetailUiModel.isSimilarVisible
